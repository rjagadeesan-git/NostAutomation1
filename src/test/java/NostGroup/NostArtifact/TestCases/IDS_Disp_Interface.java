...
public class IDS_Disp_Interface extends BrowserAct{
...
//		}
	...
	@Test(dataProvider="getData",dataProviderClass = CellDataProvider.class,priority=8,dependsOnMethods= {"nostLogin"})
...
//		}
	...
	@Test(dataProvider="getData",dataProviderClass = CellDataProvider.class,priority=12,dependsOnMethods= {"verifyCatalog"})
